...
class AttributeController extends CommonController {
    ...
    public function news(){
    	...
    	$result=$m->alias('g')->join('LEFT JOIN syj_attr_news i ON i.attr_id = g.id')->join('LEFT JOIN syh_news r ON r.id = i.news_id')->join('LEFT JOIN syh_column f ON f.id = r.nv_id')->field($field)->order('r.news_sort desc')->where($data)->select();
...
//     	exit;
    	...
    	$data['g.id']= $id;
    	$field='g.id,g.attr_name,g.attr_color,i.news_id,i.attr_id,r.nv_id,r.news_title,r.news_hits,r.news_author,r.news_addtime,r.news_updatetime,r.news_sort,f.column_name';
    	$result=$m->alias('g')->join('LEFT JOIN syh_attr_news i ON i.attr_id = g.id')->join('LEFT JOIN syh_news r ON r.id = i.news_id')->join('LEFT JOIN syh_column f ON f.id = r.nv_id')->field($field)->order('r.news_sort desc')->where($data)->limit($Page->firstRow.','.$Page->listRows)->select();
