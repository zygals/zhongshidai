...
class PersonalController extends CommonController {
    ...
    public function do_listpass() {
		...
		$data['admin_pass']=sjjiami('shangchengmanage',I('post.admin_pass'));
...
//     	exit;
    ...
    public function do_add() {
		...
		$m->admin_pass=sjjiami('shangchengmanage',I('post.admin_pass'));
...
//     	exit;
    ...
    public function do_pass(){
		...
		if ($admin_pass!==sjjiami('shangchengmanage',I('post.admin_nowpass'))){
    		$this->error('当前密码不对');
    	}
    	//**判断新密码和确认密码是否为空
