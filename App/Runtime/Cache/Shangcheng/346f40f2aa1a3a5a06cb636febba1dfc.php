...
<div class="box-personal">
   ...
   <div class="box-personal-1">
		<form>
			...
			<div class="a-1">
				<span>注册时间：</span>
				<input type="text" name="mobile" id="j_usertime"  readonly="readonly" value="<?php echo (date('Y年m月d日 H时i分s秒',$user["user_regdate"])); ?>"/>
			</div>
			<div class="a-4" >
				<a href="/ubjz3/bh/<?php echo ($user["user_login_bh"]); ?>.html" id="j_douNext"><button type="button">下一步</button></a>
			</div>
		</form> 
   </div>
   	<div class="last">
