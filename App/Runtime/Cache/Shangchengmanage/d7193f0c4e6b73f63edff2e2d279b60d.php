    ...
    <form action="/shangchengmanage/banner/sortcate" method="post" id="form_do" name="form_do">
        <table width="100%">
			...
			<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr style="height:95px;">
				...
				<td>
				<?php if($v['column_images']): ?><a href="/Uploads/<?php echo ($v["column_images"]); ?>" target="_blank"><img src="<?php echo ($v["column_images"]); ?>" width="150px" height="50px" border="0" style="background:#eee;"/></a>
				<?php else: ?>
                ...
                <td>
                    <a href="/shangchengmanage/banner/tpedit/id/<?php echo ($v["id"]); ?>">编辑</a>
