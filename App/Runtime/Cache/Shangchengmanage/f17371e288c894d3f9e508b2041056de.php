...
<table width="100%" height="31px" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">编辑帮助</div></td>
      </tr>
    </table>
<div class="main">
	<div class="form">
		<form method='post' action="/shangchengmanage/help/do_edit" enctype="multipart/form-data">
		...
		<dl>
			...
			<dl>
				<dt> 图标：</dt>
				<dd>
					<img src="<?php echo ($data["img"]); ?>" width="30" height="30" style="margin-right:10px; vertical-align: middle"><input type="file" name="img" class="inp_w250" value="" />
				</dd>
			</dl>
