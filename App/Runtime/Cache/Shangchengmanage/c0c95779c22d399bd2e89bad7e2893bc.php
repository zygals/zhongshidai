...
<table width="100%" height="31px" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">充值积分</div></td>
      </tr>
    </table>
<style>
...
<div class="main">
	...
	<div class="form" style="">
		<form method='post' id="form_do" name="form_do" action="/shangchengmanage/user/do_chongzhi">
		...
		<dl>
			<dt>充值积分：</dt>
			<dd>
				<input type="text" name="user_baodanjifen" id="user_baodanjifen" class="inp_one" onblur="return dj()" value=""/>
			</dd>
		</dl>
...
<div class="cont-ft">
    ...
    <script>
        function dj(){
            ...
            var user_baodanjifen=parseFloat($('#user_baodanjifen').val());
