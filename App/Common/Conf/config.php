...
return array(
	//'配置项'=>'配置值'
		...
		'MODULE_ALLOW_LIST' => array('Shangcheng','Shangchengpc','huodong','Member','Shangchengmanage'),// 允许访问的模块列表
		'MODULE_DENY_LIST'   => array('Common'),// 禁止访问的模块列表
		'DEFAULT_MODULE' => 'Shangcheng', //默认分组
		'IMG_URL' =>'http://sdjc.zhonghuasd.com',
		'PATH_URL' =>'http://sdjc.zhonghuasd.com/index.php/shangchengpc',
